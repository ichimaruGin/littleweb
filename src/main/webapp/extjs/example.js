Ext.example = function(){
    ...
    return {
        msg : function(title, format, dismissDelay){
            if(!msgCt){
            ...
            m.hide();
            if(Ext.isEmpty(dismissDelay)){
            	dismissDelay = 1; //若没有填写dismissDelay，默认时间为1秒
            }
            m.slideIn('t').ghost("t", { delay: dismissDelay*1000, remove: true});
        },
